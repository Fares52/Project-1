		...
		<div class="container">
				...
				<ul>
					<li>
						<svg
							...
							></path></svg
						>
						54 Rue de la République, 92150 Suresnes
					</li>
				</ul>
				<ul>
					<li>
			...
			<div class="card">
				...
				<ul>
					...
					<li>12:00 am to 2:00 pm</li>
				</ul>
				<ul>
					<li>Thursday and Friday</li>
					<li>12–2 PM to 6–9:30 PM</li>
				</ul>
				<ul>
			...
			<div class="card">
				...
				<ul class="socials">
					...
					<a href="https://www.instagram.com/la_parentheze/" target="_blank">
						<svg
							class="fill"
							xmlns="http://www.w3.org/2000/svg"
							width="42"
...
<style>
	...
	h2 {
		color: #d5b602;
		font-family: 'catchymager', cursive;
		font-size: 1.5rem;
		font-weight: lighter;
	}
	h2 span {
