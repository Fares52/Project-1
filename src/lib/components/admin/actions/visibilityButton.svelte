<script>
    ...
    <form class="visibilityForm">
        <label for="eye-{itemId}">
            ...
            <svg class="openEye" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 256 256">
            ...
            <svg class="closedEye" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 256 256">
