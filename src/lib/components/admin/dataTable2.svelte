<script>
	...
	// import AddNew from '$lib/components/admin/actions/addNew.svelte';
	...
	function getItemsByCategory(category) {
		return data?.items?.filter((item) => item.category_name === category) || [];
	}

	// console.log('Items in DataTable2:', data);
</script>
